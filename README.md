...
#ИЗ2 
Посвящено приобретению навыков системной разработки на C и работы с внешними библиотеками. В качестве результата ИЗ2 ожидается:
...
### Вывод программы
- программа выводит сумму элементов каждого из столбцов матрицы
